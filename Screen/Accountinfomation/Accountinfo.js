...
const AccountInfo = ({ isVisible, navigation }) => {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerLeft: () => (
        <TouchableOpacity onPress={() => navigation.replace("Setting")} style={{ marginLeft: 5, marginRight: 10 }}>
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => {alert("đổi tên")}} style={styles.item}>
        <View style={styles.name} >
        <Text style={styles.itemText}>Tên</Text>
        <TouchableOpacity onPress={()=>{alert("đổi tên")}} >
      ...
      <TouchableOpacity onPress={() => {handleNavigation("ResetPassword")}} style={styles.item}>
        <View style={styles.name} >
      ...
      <TouchableOpacity onPress={() => {alert("đổi tên")}} style={styles.item}>
        ...
        <TouchableOpacity onPress={()=>{alert("đổi tên")}} >
          <View style={styles.containeritemicon} >
          <Text style={styles.viewAllOrders}>huynvph20687@fpt.edu.vn</Text>
        <FontAwesome name="chevron-right" size={24} color="black" style={styles.iconitem}/>
          </View>
